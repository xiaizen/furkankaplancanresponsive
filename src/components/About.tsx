        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          >
            ...
            <img
              ...
              className="relative w-full h-[400px] md:h-[600px] object-cover grayscale hover:grayscale-0 transition-all duration-500"
            />
          </div>
          ...
          >
            ...
            <div className="h-1 w-24 bg-red-600 mb-6 md:mb-8"></div>
